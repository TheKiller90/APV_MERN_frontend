...
const Registrar = () => {
  ...
  const handleSubmit = async e => {
    ...
    const datos = [ nombre, email, password, repetirPassword ];
    if(datos.includes('')) {
    ...
    if(password !== repetirPassword) {
      setAlerta({ msg: 'Contraseña de confirmación diferente', error: true });
      return;
    }
    ...
    // setAlerta({ msg: 'Usuario validado', error: false});
    setAlerta({  });
